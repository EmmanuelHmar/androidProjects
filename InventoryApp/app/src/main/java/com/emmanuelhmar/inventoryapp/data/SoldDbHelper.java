...
public class SoldDbHelper extends SQLiteOpenHelper {
    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME = "sold.db";

    private static final String SQL_CREATE_ENTRIES = "CREATE TABLE " + ItemContract.ItemEntry.SOLD_TABLE_NAME +
    ...
    private static final String SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS " + ItemContract.ItemEntry.SOLD_TABLE_NAME;

    public SoldDbHelper(Context context) {
